/*
// Computes estimates for AR-MSI models with EM-algorithm.
...
Xi FilterARMSIQuZhuo (arma::colvec* py,
                arma::mat* py_lagged,
...
Xi ExpectationStepARMSIQuZhuo	(arma::colvec* py,
                         arma::mat* py_lagged,
                         arma::mat* pz_dependent,
                         arma::mat* pz_independent,
                         Theta* ptheta)
{
  Xi filter = FilterARMSIQuZhuo(py, py_lagged, pz_dependent, pz_independent,
                          ptheta);
...
Theta MaximizationStepARMSIQuZhuo (arma::colvec* py,
                            arma::mat* py_lagged,
                            arma::mat* pz_dependent,
                            arma::mat* pz_independent,
